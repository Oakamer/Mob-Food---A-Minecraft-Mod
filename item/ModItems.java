...
public class ModItems {
    ...
    public static final RegistryObject<Item> SPIDER_BLOOD_PURIFIED = ITEMS.register("spider_blood_purified",
            () -> new Item(new Item.Properties().food(ModFoodProperties.SPIDER_BLOOD_PURIFIED)));

    public static final RegistryObject<Item> HARDENED_SPIDER_BLOOD = ITEMS.register("hardened_spider_blood",
            () -> new Item(new Item.Properties()));
    //Mob Food------------------------------------------------------
